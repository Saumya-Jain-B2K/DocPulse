        ...
        {appointments.map((item, index) => (
          ...
          key={index}>
            ...
            <div className='flex flex-col gap-2 justify-end'>
              {!item.cancelled && <button onClick={() => appointmentRazorpay(item._id)} className='text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-[#000B6D] hover:text-white transition-all duration-300'>Pay Online</button>}

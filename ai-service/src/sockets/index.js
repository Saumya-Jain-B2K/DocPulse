...
module.exports = (server) => {
    ...
    io.use((socket, next) => {
        try {
            ...
            if (!token) {
                return next(new Error("Authentication error: Token missing. Please log in again."));
            }
    ...
    io.on("connection", (socket) => {
        console.log(`🔒 Authenticated User connected to AI Service [ID: ${socket.userId}] (Socket: ${socket.id})`);
